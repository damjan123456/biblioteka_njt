// src/main/java/com/biblioteka/biblioteka_backend/web/ClanController.java
...
public class ClanController {
    ...
    public ResponseEntity<ClanDTO> register(@Valid @RequestBody ClanCreateReq req) {
        ...
        Clan c = Clan.builder()
                ...
                .datumUclanjenja(req.getDatumUclanjenja())
                .ukupnoPoena(0)
                .uloga(uloga)
        ...
        d.setDatumUclanjenja(c.getDatumUclanjenja());
        d.setUkupnoPoena(c.getUkupnoPoena());
        d.setUlogaId(uloga.getId());

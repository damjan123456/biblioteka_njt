...
public class LoyaltyPraviloController {
    ...
    @PostMapping
    public ResponseEntity<LoyaltyPravilo> create(@Valid @RequestBody LoyaltyPraviloCreateReq req) {
        return ResponseEntity.ok(service.create(req));
    }

    @PutMapping("/{id}")
    public ResponseEntity<LoyaltyPravilo> update(@PathVariable Integer id, @Valid @RequestBody LoyaltyPraviloCreateReq req) {

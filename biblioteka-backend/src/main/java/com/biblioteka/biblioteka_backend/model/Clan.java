...
public class Clan {
    ...
    @Column(name = "id_clan") private Integer id;
    ...
    @Column(name = "telefon", length = 50)                     private String telefon;
    @Column(name = "adresa", length = 255)                      private String adresa;
    @Column(name = "datum_uclanjenja", nullable = false)        private LocalDate datumUclanjenja;
    @Column(name = "ukupno_poena", nullable = false)            private Integer ukupnoPoena;

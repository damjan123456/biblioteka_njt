...
public class Pozajmica {
    ...
    @Column(name = "datum_pozajmice", nullable = false)      private LocalDate datumPozajmice;
    @Column(name = "datum_roka_pozajmice", nullable = false)  private LocalDate datumRokaPozajmice;

    @Column(name = "ukupna_kazna", nullable = false)          private BigDecimal ukupnaKazna;
    @Column(name = "ukupan_broj_poena", nullable = false)     private Integer ukupanBrojPoena;
